...
# Separate data into two groups based on a condition
amors_neo <- nrow(df[df$material == "metallic" & df$neo == "Amors", ])
apollos_neo <- nrow(df[df$material == "metallic" & df$neo == "Apollos", ])

# Counting occurrences of each category in each group
amors_metallic_neo_count <- length(df$material)
apollos_metallic_neo_count <- length(df$material)

# amors_metallic_neo_count <- nrow(df[df$material == "metallic", ])
# apollo_metallic_neo_count <- nrow(df[df$material == "metallic", ])

# Hypothesis test
prop.test(x = c(amors_neo, apollos_neo), n = c(amors_metallic_neo_count, apollos_metallic_neo_count),
          alternative = "greater", conf.level = 1-0.0001,
          correct = F)
```
...
# Separate data into two groups based on a condition
amors_neo <- nrow(df[df$material == "metallic" & df$neo == "Amors", ])
atens_neo <- nrow(df[df$material == "metallic" & df$neo == "Atens", ])

# Counting occurrences of each category in each group
amors_metallic_neo_count <- length(df$material)
atens_metallic_neo_count <- length(df$material)

# amors_metallic_neo_count <- nrow(df[df$material == "metallic", ])
# apollo_metallic_neo_count <- nrow(df[df$material == "metallic", ])

# Hypothesis test
prop.test(x = c(amors_neo, atens_neo), n = c(amors_metallic_neo_count, atens_metallic_neo_count),
          alternative = "greater", conf.level = 1-0.0001,
          correct = F)
```
...
# Separate data into two groups based on a condition
amors_neo <- nrow(df[df$material == "metallic" & df$neo == "Amors", ])
atiras_neo <- nrow(df[df$material == "metallic" & df$neo == "Atiras", ])

# Counting occurrences of each category in each group
amors_metallic_neo_count <- length(df$material)
atiras_metallic_neo_count <- length(df$material)

# amors_metallic_neo_count <- nrow(df[df$material == "metallic", ])
# apollo_metallic_neo_count <- nrow(df[df$material == "metallic", ])

# Hypothesis test
prop.test(x = c(amors_neo, atiras_neo), n = c(amors_metallic_neo_count, atiras_metallic_neo_count),
          alternative = "greater", conf.level = 1-0.0001,
          correct = F)
```
...
# Separate data into two groups based on a condition
apollos_neo <- nrow(df[df$material == "metallic" & df$neo == "Apollosr", ])
atens_neo <- nrow(df[df$material == "metallic" & df$neo == "Atens", ])
...
# Hypothesis test
prop.test(x = c(apollos_neo, atens_neo), n = c(apollos_metallic_neo_count, atens_metallic_neo_count),
          alternative = "greater", conf.level = 1-0.0001,
          correct = F)
```
...
# Hypothesis test
prop.test(x = c(apollos_neo, atiras_neo), n = c(apollos_metallic_neo_count, atiras_metallic_neo_count),
          alternative = "greater", conf.level = 1-0.0001,
          correct = F)
```
...
# Hypothesis test
prop.test(x = c(atens_neo, atiras_neo), n = c(atens_metallic_neo_count, atiras_metallic_neo_count),
          alternative = "greater", conf.level = 1-0.0001,
          correct = F)
```
...
# neo_type <- "Amors"
# 
# # Extracting the count from the contingency table
# count_metallic_amors <- contingency_table_neotype_material[neo_type, material == "metallic"]
# count_carbonaceous_amors <- contingency_table_neotype_material[neo_type, material == "carbonaceous"]
# total_material_amors <- sum(count_metallic_amors, count_carbonaceous_amors)
# 
# 
# # APOLLOS
# neo_type <- "Apollos"
# 
# # Extracting the count from the contingency table
# count_metallic_apollos <- contingency_table_neotype_material[neo_type, material == "metallic"]
# count_carbonaceous_apollos <- contingency_table_neotype_material[neo_type, material == "carbonaceous"]
# total_material_apollos <- sum(count_metallic_apollos, count_carbonaceous_apollos)
# 
# 
# # ATENS
# neo_type <- "Atens"
# 
# # Extracting the count from the contingency table
# count_metallic_atens <- contingency_table_neotype_material[neo_type, material == "metallic"]
# count_carbonaceous_atens <- contingency_table_neotype_material[neo_type, material == "carbonaceous"]
# total_material_atens <- sum(count_metallic_atens, count_carbonaceous_atens)
# 
# 
# # ATIRAS
# neo_type <- "Atiras"
# 
# # Extracting the count from the contingency table
# count_metallic_atiras <- contingency_table_neotype_material[neo_type, material == "metallic"]
# count_carbonaceous_atiras <- contingency_table_neotype_material[neo_type, material == "carbonaceous"]
# total_material_atiras <- sum(count_metallic_atiras, count_carbonaceous_atiras)
# 
# ```

```{r, echo=TRUE}
# metallic occurrences for Amons
count_amons <- table((df$neo_type == "Amons")[df$material == "metallic"])
count_amons
# metallic occurrences for Apollos
count_apollos <- table((df$neo_type == "Apollos")[df$material == "metallic"])
count_apollos
# 2x2 matrix for the contingency table
contingency_table <- matrix(c(count_amons, !count_amons,
                              count_apollos, !count_apollos),
                            nrow = 2)

# Perform the two-sample proportion test
test_result <- prop.test(x = contingency_table[, 1], n = rowSums(contingency_table),
                         alternative = "greater", conf.level = 0.9999, correct = FALSE)
...
# Identify the asteroid type with the highest proportion of metallic asteroids
