...
amors_met_ct <- nrow(amors_metallic)
apollos_met_ct <- nrow(apollos_metallic)

amors_tot_ct <- nrow(df[df$neo_type == "Amors", ])
apollos_tot_ct <- nrow(df[df$neo_type == "Apollos", ])

# Hypothesis test
amors_apollos_metallic_proportion <- 
  prop.test(x = c(amors_met_ct, apollos_met_ct),
          n = c(amors_tot_ct, apollos_tot_ct),
...
print(noquote("We fail to reject the H0: Not enough evidence to conclude statistical difference."))
}
...
if (amors_quantity > apollos_quantity) {
  print(noquote
        (paste("Metallic proportion in Amors > in Apollos, with a proportion of", 
               amors_quantity)))
} else {
  print(noquote
        (paste("Metallic material proportion in Apollos > in Amors, with a proportion of", 
               apollos_quantity)))
}
...
print(noquote
      ("We fail to reject the H0: Not enough evidence of statistical difference."))
}
...
if (amors_quantity > atens_quantity) {
  print(noquote
        (paste("Metallic material proportion in Amors > in Atens, with a proportion of", 
               amors_quantity)))
} else {
  print(noquote
        (paste("Metallic material proportion in Atens is greater than in Amors, with a proportion of", 
               atens_quantity)))
}
...
amors_met_ct <- nrow(amors_metallic)
atiras_met_ct <- nrow(atiras_metallic)

amors_tot_ct <- nrow(df[df$neo_type == "Amors", ])
atiras_tot_ct <- nrow(df[df$neo_type == "Atiras", ])

# Hypothesis test
amors_atiras_metallic_proportion <- 
  prop.test(x = c(amors_met_ct, atiras_met_ct),
          n = c(amors_tot_ct, atiras_tot_ct),
          alternative = "two.sided", conf.level = 0.9999,
          correct = FALSE)
...
print(noquote
      ("Reject H0: Metallic material proportion in Amors != in Atiras."))
} else {
print(noquote
      ("We fail to reject the H0: Not enough evidence to conclude statistical difference."))
}
...
if (amors_quantity > atiras_quantity) {
  print(noquote
        (paste("Metallic material proportion in Amors > in Atiras, with a proportion of", 
               amors_quantity)))
} else {
  print(noquote
        (paste("Metallic material proportion in Atiras > in Amors, with a proportion of", 
               atiras_quantity)))
}
...
apollos_met_ct <- nrow(apollos_metallic)
atens_met_ct <- nrow(atens_metallic)

apollos_tot_ct <- nrow(df[df$neo_type == "Apollos", ])
atens_tot_ct <- nrow(df[df$neo_type == "Atens", ])

# Hypothesis test
apollos_atens_metallic_proportion <- 
  prop.test(x = c(apollos_met_ct, atens_met_ct),
          n = c(apollos_tot_ct, atens_tot_ct),
          alternative = "two.sided", conf.level = 0.9999,
          correct = FALSE)
...
if (apollos_quantity > atens_quantity) {
  print(noquote
        (paste("Metallic material proportion in Apollos > in Atens, with a proportion of", 
               apollos_quantity)))
} else {
  print(noquote
        (paste("Metallic material proportion in Atens > in Apollos, with a proportion of", 
               atens_quantity)))
}
```
...
apollos_atiras_metallic_proportion <- 
  prop.test(x = c(apollos_met_ct, atiras_met_ct),
          n = c(apollos_tot_ct, atiras_tot_ct),
          alternative = "two.sided", conf.level = 0.9999,
          correct = FALSE)
...
if (apollos_quantity > atiras_quantity) {
  print(noquote
        (paste("Metallic material proportion in Apollos > in Atiras, with a proportion of", 
               apollos_quantity)))
} else {
  print(noquote
        (paste("Metallic material proportion in Atiras > in Apollos, with a proportion of", 
               atiras_quantity)))
}
```
...
atens_atiras_metallic_proportion <- 
  prop.test(x = c(atens_met_ct, atiras_met_ct),
          n = c(atens_tot_ct, atiras_tot_ct),
          alternative = "two.sided", conf.level = 0.9999,
          correct = FALSE)
...
if (atens_quantity < atiras_quantity) {
  print(noquote
        (paste("Metallic material proportion in Atiras > in Atens, with a proportion of", 
               atiras_quantity)))
} else {
  print(noquote
        (paste("Metallic material proportion in Atens > in Atiras, with a proportion of", 
               atens_quantity)))
}
